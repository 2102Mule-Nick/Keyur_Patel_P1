...
public class AppConfig {
	...
	// JMS Destinations Queue
	public static final String SMS_WEB_USER_QUEUE = "SMS_WEB_USER_LIST";
	
	// JMS Destinations Topic
	public static final String SMS_PLAYER_TOPIC = "SMS_PLAYER_LIST";

	// DataSource info
	public static final String DATASOURCE_SCHEMA = System.getenv("public");
	...
	public Queue destinationQueue() {
		return new ActiveMQQueue(SMS_WEB_USER_QUEUE);
	}
	
/*	@Bean
	public Topic destinationTopic() {
		return new ActiveMQQueue(SMS_PLAYER_TOPIC);
	}
*/
